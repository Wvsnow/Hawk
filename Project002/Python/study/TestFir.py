...
################################# #################################  #################################      
#################################             subMain003():      current test funcion
def subMain003():
...
################################# #################################  #################################      
#################################             subMain004():            current test funcion
def subMain004():
...
################################# #################################  #################################      os-module test
#################################             subMain005():       文件测试有关    current test funcion
def subMain005():
    ################################# Testing the method of application of
    print(" ================================================================================ ") 
...
################################# #################################  #################################      
#################################             subMain006():      current test funcion
def subMain006():
